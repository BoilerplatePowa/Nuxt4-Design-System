            ...
            const positions = [
                {
                    horizontal: 'start',
                    vertical: 'top',
                    expected: ['indicator-top', 'indicator-start'],
                },
                {
                    horizontal: 'center',
                    vertical: 'top',
                    expected: ['indicator-top', 'indicator-center'],
                },
                {
                    horizontal: 'end',
                    vertical: 'top',
                    expected: ['indicator-top', 'indicator-end'],
                },
                {
                    horizontal: 'start',
                    vertical: 'middle',
                    expected: ['indicator-middle', 'indicator-start'],
                },
                {
                    horizontal: 'center',
                    vertical: 'middle',
                    expected: ['indicator-middle', 'indicator-center'],
                },
                {
                    horizontal: 'end',
                    vertical: 'middle',
                    expected: ['indicator-middle', 'indicator-end'],
                },
                {
                    horizontal: 'start',
                    vertical: 'bottom',
                    expected: ['indicator-bottom', 'indicator-start'],
                },
                {
                    horizontal: 'center',
                    vertical: 'bottom',
                    expected: ['indicator-bottom', 'indicator-center'],
                },
                {
                    horizontal: 'end',
                    vertical: 'bottom',
                    expected: ['indicator-bottom', 'indicator-end'],
                },
            ]
