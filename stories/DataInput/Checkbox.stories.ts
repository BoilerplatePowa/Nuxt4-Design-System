  ...
  render: () => ({
    ...
    data() {
      return {
        selectedItems: ['item2'],
        items: [
          { id: 'item1', label: 'Option 1', description: 'First option with description' },
          { id: 'item2', label: 'Option 2', description: 'Second option (pre-selected)' },
          { id: 'item3', label: 'Option 3', description: 'Third option available' },
          { id: 'item4', label: 'Option 4', description: 'Fourth option disabled', disabled: true },
        ],
      };
    },
    methods: {
