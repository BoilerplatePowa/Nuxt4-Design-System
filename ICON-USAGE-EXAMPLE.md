...
<template>
    ...
    <Button :icon-left="Settings"> Settings </Button>

    <!-- Button with both icons -->
    <Button :icon-left="Save" :icon-right="ArrowRight"> Save and Continue </Button>

    <!-- Button with custom icon size -->
    <Button :icon-left="Settings" icon-size="lg"> Large Icon </Button>
</template>
```
...
<template>
    ...
    <Input :left-icon="Search" :right-icon="X" placeholder="Search..." />
...
<template>
    ...
    <Avatar :fallback-icon="User" name="John Doe" />

    <!-- Avatar with image (fallback icon used if image fails) -->
    <Avatar src="/avatar.jpg" :fallback-icon="User" alt="User avatar" />
</template>
```
...
```vue
<script setup lang="ts">
import { HomeIcon, Cog6ToothIcon, UserIcon } from '@heroicons/vue/24/outline'
    ...
    <Button>
        <template #icon-left>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                <path
                    d="M10 3.5a6.5 6.5 0 100 13 6.5 6.5 0 000-13zM2 10a8 8 0 1116 0 8 8 0 01-16 0z"
                />
            </svg>
        </template>
        Custom Icon
...
<template>
    <Button>
        <template #icon-left>
            <div class="relative">
                <Bell :size="20" />
                <span class="absolute -top-1 -right-1 badge badge-xs badge-error"> 3 </span>
            </div>
        </template>
        Notifications
    </Button>
...
<template>
    <Button :icon-left="Settings" :icon-size="ICON_SIZES.md"> Settings </Button>
</template>
```
...
<Button icon-left="Settings"></Button>
```
