...
// Checkout steps
const checkoutSteps = [
  { title: 'Cart', description: 'Review items', icon: 'shopping-cart' as const },
  { title: 'Shipping', description: 'Delivery details', icon: 'map-pin' as const },
  { title: 'Payment', description: 'Billing information', icon: 'credit-card' as const },
  { title: 'Confirmation', description: 'Order complete', icon: 'check' as const },
];

// Order tracking steps
const orderTrackingSteps = [
  { title: 'Ordered', description: 'Order placed', icon: 'package' as const },
  { title: 'Processing', description: 'Being prepared', icon: 'settings' as const },
  { title: 'Shipped', description: 'In transit', icon: 'truck' as const },
  { title: 'Delivered', description: 'At destination', icon: 'home' as const },
];
...
export const InteractiveSteps: Story = {
  render: () => ({
    ...
    setup() {
      ...
      const steps = [
        { title: 'Personal Info', description: 'Tell us about yourself', icon: 'user' as const },
        { title: 'Preferences', description: 'Set your preferences', icon: 'settings' as const },
        { title: 'Confirmation', description: 'Review and confirm', icon: 'check-circle' as const },
      ];
...
export const VerticalWithIcons: Story = {
  args: {
    steps: [
      { title: 'Setup', description: 'Initial setup', icon: 'settings' as const },
      { title: 'Configure', description: 'Configuration', icon: 'settings' as const },
      { title: 'Test', description: 'Testing phase', icon: 'settings' as const },
      { title: 'Deploy', description: 'Deployment', icon: 'settings' as const },
    ],
    currentStep: 2,
    variant: 'vertical',
    showNumbers: false,
