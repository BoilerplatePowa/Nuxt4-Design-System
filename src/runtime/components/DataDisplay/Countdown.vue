<template>
  <div class="countdown-container">
    <div v-if="showLabels" class="countdown-labels">
      <span v-if="showDays" class="countdown-label">days</span>
      <span v-if="showHours" class="countdown-label">hours</span>
    ...
    <div :class="countdownClasses">
      <span v-if="showDays" :style="{ '--value': timeLeft.days }" class="countdown-item" />
      <span v-if="showHours" :style="{ '--value': timeLeft.hours }" class="countdown-item" />
      <span v-if="showMinutes" :style="{ '--value': timeLeft.minutes }" class="countdown-item" />
      <span v-if="showSeconds" :style="{ '--value': timeLeft.seconds }" class="countdown-item" />
    </div>
