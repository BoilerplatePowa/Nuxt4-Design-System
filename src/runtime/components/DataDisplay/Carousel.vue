...
<div :class="wrapperClasses">
    ...
    <div :class="carouselClasses">
        <!-- Side Controls -->
        <div
            v-if="showArrows && controllerPosition === 'sides'"
            class="carousel-controls-sides"
        >
            <div
            ...
            >
                <slot name="prev-arrow">
                    <button class="carousel-side-btn">
                        ❮
                    </button>
                </slot>
            </div>
    ...
    >
        ...
        <!-- Line Pagination -->
        <div
            v-else-if="paginationType === 'line'"
            class="carousel-pagination-line"
        >
    ...
    >
        ...
        >
            <slot name="prev-arrow">
                <button :class="getArrowButtonClasses()">
                    ❮
                </button>
            </slot>
        </div>
        ...
        <div
            v-if="showIndicators"
            class="carousel-pagination-between"
        >
            <!-- Numbers Pagination -->
            <div
                v-if="paginationType === 'numbers'"
