<template>
  <footer :class="footerClasses">
    <slot>
      <div v-if="showBranding" class="footer-branding">
        <div class="flex items-center gap-3">
          <img v-if="logo" :src="logo" :alt="logoAlt" class="h-8 w-auto" />
          <div>
            <p v-if="brandName" class="font-bold text-lg">
              {{ brandName }}
            </p>
            <p v-if="brandDescription" class="text-sm opacity-70">
              {{ brandDescription }}
            </p>
          </div>
        </div>
      ...
      <div v-if="links && links.length > 0" class="footer-links">
        <div v-for="section in links" :key="section.title" class="footer-section">
          <h3 v-if="section.title" class="footer-title">
            {{ section.title }}
          </h3>
      ...
      <div v-if="social && social.length > 0" class="footer-social">
    ...
    <div v-if="showCopyright" class="footer-center">
