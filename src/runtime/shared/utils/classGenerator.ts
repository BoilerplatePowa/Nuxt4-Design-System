...
import { fabPartMap, fabModifierMap, fabBaseClass } from '../componentsMaps/actions/fabMap'
...
import { radioColorMap, radioSizeMap, radioBaseClass } from '../componentsMaps/data-input/radioMap'

import { rangeColorMap, rangeSizeMap, rangeBaseClass } from '../componentsMaps/data-input/rangeMap'
...
import { progressColorMap, progressBaseClass } from '../componentsMaps/feedback/progressMap'
...
import { navbarPartMap, navbarBaseClass } from '../componentsMaps/navigation/navbarMap'
...
import { linkStyleMap, linkColorMap, linkBaseClass } from '../componentsMaps/navigation/linkMap'
...
import { heroPartMap, heroBaseClass } from '../componentsMaps/layout/heroMap'
...
import { maskStyleMap, maskModifierMap, maskBaseClass } from '../componentsMaps/layout/maskMap'
...
import { filterPartMap, filterBaseClass } from '../componentsMaps/data-input/filterMap'

import { validatorPartMap, validatorBaseClass } from '../componentsMaps/data-input/validatorMap'
...
import { diffPartMap, diffBaseClass } from '../componentsMaps/data-display/diffMap'

import { kbdSizeMap, kbdBaseClass } from '../componentsMaps/data-display/kbdMap'
 ...
 */
export function generateProgressClasses(props: { color?: keyof typeof progressColorMap }) {
 ...
 */
export function generateStatClasses(props: { parts?: Array<keyof typeof statPartMap> }) {
 ...
 */
export function generateStatsClasses(props: { direction?: keyof typeof statsDirectionMap }) {
 ...
 */
export function generateNavbarClasses(props: { parts?: Array<keyof typeof navbarPartMap> }) {
 ...
 */
export function generateHeroClasses(props: { parts?: Array<keyof typeof heroPartMap> }) {
 ...
 */
export function generateFieldsetClasses(props: { parts?: Array<keyof typeof fieldsetPartMap> }) {
 ...
 */
export function generateFilterClasses(props: { parts?: Array<keyof typeof filterPartMap> }) {
 ...
 */
export function generateValidatorClasses(props: { parts?: Array<keyof typeof validatorPartMap> }) {
 ...
 */
export function generateDiffClasses(props: { parts?: Array<keyof typeof diffPartMap> }) {
 ...
 */
export function generateKbdClasses(props: { size?: keyof typeof kbdSizeMap }) {
 ...
 */
export function generateListClasses(props: { modifiers?: Array<keyof typeof listModifierMap> }) {
