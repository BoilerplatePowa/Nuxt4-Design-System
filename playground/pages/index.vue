      ...
      <div class="hero-content text-center">
        <div class="max-w-4xl">
          ...
          <p class="text-xl mb-8 text-base-content/80">
            A modern, accessible design system built for Nuxt 4+ with TailwindCSS, DaisyUI, and
            comprehensive component mapping. Build beautiful, consistent interfaces with ease.
          </p>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body text-center">
              ...
              <p>
                Optimized for performance with tree-shaking, lazy loading, and efficient bundling
              </p>
            </div>
          </div>
        ...
        <div class="grid lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div class="mockup-code text-left">
              <pre
                data-prefix="$"
              ><code>npm install @boilerplatepowa/nuxt4-design-system</code></pre>
            </div>
    ...
    <section class="py-16">
      <div class="container mx-auto px-4">
        ...
        <div class="text-center mt-8">
          <NuxtLink to="/components" class="btn btn-outline btn-lg"> View All Components </NuxtLink>
        </div>
      </div>
    </section>
