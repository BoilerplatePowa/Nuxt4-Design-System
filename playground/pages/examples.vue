    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-base-content/70 max-w-3xl mx-auto">
          Interactive examples and code snippets for all components. See them in action and copy the
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <BpButton v-for="color in buttonColors" :key="color" :color="color" size="sm">
                        {{ color }}
                      </BpButton>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                      <BpButton color="primary" :is-loading="isLoading" @click="toggleLoading">
                        {{ isLoading ? 'Loading...' : 'Click Me' }}
                      </BpButton>
                      <BpButton color="secondary" :is-disabled="isDisabled" @click="toggleDisabled">
              ...
              <div>
                ...
                <div class="mockup-code text-left">
                  <pre v-for="line in getButtonCode()" :key="line.code" :data-prefix="line.prefix">
                    <code>{{ line.code }}</code>
                  </pre>
                </div>
              </div>
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-6 gap-3">
                      ...
                      >
                        <BpIcon :name="icon.name as any" :class="icon.class" />
                  ...
                  <div v-if="selectedIcon" class="p-4 bg-base-300 rounded">
                    ...
                    <div class="flex items-center gap-4">
                      <BpIcon :name="selectedIcon as any" class="w-8 h-8 text-primary" />
                      <BpIcon :name="selectedIcon as any" class="w-12 h-12 text-secondary" />
                      <BpIcon :name="selectedIcon as any" class="w-16 h-16 text-accent" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div class="space-y-3">
                      ...
                      <input
                        ...
                        class="input input-bordered w-full"
                      />
                      <textarea placeholder="Textarea" class="textarea textarea-bordered w-full" />
                    </div>
                  </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div class="border border-base-300 rounded-lg p-4 min-h-[200px] bg-base-100">
                  ...
                  <div v-else-if="playgroundCode.trim()" v-html="compiledPreview" />
      ...
      <section class="mb-16">
        <div class="card bg-primary text-primary-content shadow-xl">
          <div class="card-body text-center">
            ...
            <p class="mb-6">
              Start building with our components. Copy the code examples and customize them for your
              projects.
            </p>
