    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-base-content/70 max-w-3xl mx-auto">
          Interactive examples and code snippets for all components. See them in action and copy the code for your projects.
        </p>
      </div>
              ...
              <div>
                ...
                <div class="tabs tabs-boxed mb-4">
                  <a 
                    ...
                    :key="tab.id"
                    class="tab"
                    :class="{ 'tab-active': activeButtonTab === tab.id }"
                ...
                <div class="mockup-code text-left">
                  <pre v-for="line in getButtonCode()" :key="line" :data-prefix="line.prefix">
                    <code>{{ line.code }}</code>
                  </pre>
                </div>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-6 gap-3">
                      ...
                      >
                        <BpIcon :name="icon.name" :class="icon.class" />
                  ...
                  <div v-if="selectedIcon" class="p-4 bg-base-300 rounded">
                    <p class="text-sm font-medium mb-2">Selected Icon: {{ selectedIcon }}</p>
                    <div class="flex items-center gap-4">
                      <BpIcon :name="selectedIcon" class="w-8 h-8 text-primary" />
                      <BpIcon :name="selectedIcon" class="w-12 h-12 text-secondary" />
                      <BpIcon :name="selectedIcon" class="w-16 h-16 text-accent" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="mockup-code text-left">
                  <pre data-prefix="<"><code>&lt;Icon name="heart" class="w-6 h-6 text-error" /&gt;</code></pre>
                  <pre data-prefix="<"><code>&lt;Icon name="star" class="w-8 h-8 text-warning" /&gt;</code></pre>
                  <pre data-prefix="<"><code>&lt;Icon name="check-circle" class="w-10 h-10 text-success" /&gt;</code></pre>
                  <pre data-prefix="<"><code>&lt;Icon name="info" class="w-12 h-12 text-info" /&gt;</code></pre>
                </div>
                ...
                <div class="mt-4 p-4 bg-base-300 rounded">
                  ...
                  <p class="text-xs text-base-content/70">
                    ...
                    <a href="https://lucide.dev/icons" target="_blank" class="link link-primary">lucide.dev</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                  ...
                  <div>
                    ...
                    <div class="flex gap-2">
                      ...
                      <BpButton color="ghost" size="sm">Reset</BpButton>
              ...
              <div>
                ...
                <div class="mockup-code text-left">
                  <pre data-prefix="<"><code>&lt;input type="text" placeholder="Text input" class="input input-bordered w-full" /&gt;</code></pre>
                  <pre data-prefix="<"><code>&lt;textarea placeholder="Textarea" class="textarea textarea-bordered w-full"&gt;&lt;/textarea&gt;</code></pre>
            ...
            <div class="grid lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div class="mt-4 flex gap-2">
                  <button @click="runCode" class="btn btn-primary btn-sm">
                    <BpIcon name="zap" class="w-4 h-4 mr-2" />
                    Run Code
                  </button>
                  <button @click="resetCode" class="btn btn-ghost btn-sm">
              ...
              <div>
                ...
                <div class="border border-base-300 rounded-lg p-4 min-h-[200px] bg-base-100">
                  <div v-if="previewError" class="text-error text-sm">
                    {{ previewError }}
                  </div>
                  <div v-else-if="playgroundCode.trim()" v-html="compiledPreview"></div>
                  <div v-else class="text-base-content/50 text-center py-8">
                    <BpIcon name="file" class="w-12 h-12 mx-auto mb-2 opacity-50" />
      ...
      <section class="mb-16">
        <div class="card bg-primary text-primary-content shadow-xl">
          <div class="card-body text-center">
            ...
            <p class="mb-6">
              Start building with our components. Copy the code examples and customize them for your projects.
            </p>
...
function getButtonCode() {
  switch (activeButtonTab.value) {
    case 'colors':
      return [
        { prefix: '<', code: 'BpButton color="primary">Primary</BpButton>' },
        { prefix: '<', code: 'BpButton color="secondary">Secondary</BpButton>' },
        { prefix: '<', code: 'BpButton color="accent">Accent</BpButton>' }
      ]
    case 'sizes':
      return [
        { prefix: '<', code: 'BpButton color="primary" size="xs">XS</BpButton>' },
        { prefix: '<', code: 'BpButton color="primary" size="lg">LG</BpButton>' }
      ]
    case 'states':
      return [
        { prefix: '<', code: 'BpButton color="primary" :is-loading="true">Loading</BpButton>' },
        { prefix: '<', code: 'BpButton color="primary" :is-disabled="true">Disabled</BpButton>' }
      ]
    default:
      return []
  }
