    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-base-content/70 max-w-3xl mx-auto">
          Explore our comprehensive collection of pre-built, accessible components. Each component
          is designed with modern web standards and follows DaisyUI conventions.
        </p>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div
          ...
          @click="navigateToCategory('actions')"
        >
          <div class="card-body">
            ...
            <p class="text-base-content/70 mb-4">
              Interactive elements like buttons, dropdowns, modals, and other action-oriented
              components.
            </p>
        ...
        <div
          class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer"
          @click="navigateToCategory('data-display')"
        >
          <div class="card-body">
            <div class="flex items-center gap-4 mb-4">
        ...
        <div
          class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer"
          @click="navigateToCategory('data-input')"
        >
          <div class="card-body">
            <div class="flex items-center gap-4 mb-4">
        ...
        <div
          class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer"
          @click="navigateToCategory('feedback')"
        >
          <div class="card-body">
            <div class="flex items-center gap-4 mb-4">
        ...
        <div
          class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer"
          @click="navigateToCategory('layout')"
        >
          <div class="card-body">
            <div class="flex items-center gap-4 mb-4">
        ...
        <div
          class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow cursor-pointer"
          @click="navigateToCategory('navigation')"
        >
          <div class="card-body">
            <div class="flex items-center gap-4 mb-4">
        ...
        <div class="grid lg:grid-cols-2 gap-8">
          ...
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body">
              ...
              <p class="text-base-content/70 mb-4">
                ...
                DaisyUI button styles with enhanced functionality.
              </p>
              ...
              <div class="space-y-4 mb-6">
                <div class="flex flex-wrap gap-2">
                  ...
                  <BpButton style="ghost" size="sm"> Ghost </BpButton>
                </div>
          ...
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body">
              ...
              <p class="text-base-content/70 mb-4">
                A comprehensive icon component powered by Lucide Vue Next. Access to 1000+
      ...
      <section class="mb-16">
        <div class="card bg-primary text-primary-content shadow-xl">
          <div class="card-body text-center">
            ...
            <p class="mb-6">
              Dive deep into our component library and discover all the possibilities for building
              amazing interfaces.
            </p>
...
definePageMeta({
  title: 'Components',
  description:
    'Comprehensive component library for Nuxt Design System - browse all available components by category',
})
