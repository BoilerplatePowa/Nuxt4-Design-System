<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Validator</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Change styles based on validity.</p>
            </div>
            ...
            <section class="mb-16">
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body space-y-2">
                        <input type="email" required placeholder="Email" class="input validator" />
...
definePageMeta({ title: 'Validator', description: 'Validator usage examples' })
