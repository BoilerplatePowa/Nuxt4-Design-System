<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">BpRange</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Slider for selecting a value.</p>
            </div>
...
definePageMeta({ title: 'Range Component', description: 'Examples and usage for range slider' })
