<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Fieldset</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Group related form elements.</p>
            </div>
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body">
                        <fieldset class="fieldset">
                            ...
                            <p class="label">We will never share your details.</p>
                        </fieldset>
                    </div>
                </div>
            </section>
