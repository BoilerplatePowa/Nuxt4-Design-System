        ...
        <div class="container mx-auto px-4 py-8">
            <div class="text-sm breadcrumbs mb-6">
                <ul>
                    ...
                    <li><NuxtLink to="/components/data-input">Data Input</NuxtLink></li>
                    <li>Radio</li>
                </ul>
            </div>

            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">BpRadio</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Radio buttons with color/size options.</p>
            </div>
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body space-y-4">
                        <div class="flex items-center gap-6">
                            <input type="radio" name="opt" class="radio radio-primary" checked />
                            <input type="radio" name="opt" class="radio radio-secondary" />
                            <input type="radio" name="opt" class="radio radio-accent" />
                        </div>
                        <div class="flex items-center gap-6">
                            <input type="radio" name="size" class="radio radio-sm" checked />
...
definePageMeta({ title: 'Radio Component', description: 'Examples and usage for radio' })
