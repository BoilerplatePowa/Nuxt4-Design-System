<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Calendar</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Calendar styles for libraries.</p>
            </div>
            ...
            <section class="mb-16">
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body space-y-4">
                        <input type="text" class="input pika-single" placeholder="Pick a date" />
                        <div class="react-day-picker border p-4 rounded">DayPicker container</div>
                    </div>
                </div>
            </section>
