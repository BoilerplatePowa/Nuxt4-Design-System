    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="mb-12">
        ...
        <p class="text-lg text-base-content/70 max-w-3xl">
          Action components are the building blocks of user interactions in your application. They
          provide consistent, accessible interfaces for buttons, dropdowns, modals, and other
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow">
          <div class="card-body">
            ...
            <p class="text-base-content/70 mb-4">
              A dropdown menu component for displaying lists of actions or options. Supports various
              trigger types and positioning.
            </p>
        ...
        <div class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow">
          <div class="card-body">
            ...
            <p class="text-base-content/70 mb-4">
              A modal dialog component for overlaying content. Supports various sizes, animations,
        ...
        <div class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow">
          <div class="card-body">
            ...
            <p class="text-base-content/70 mb-4">
              A swap component for toggling between two states or content views. Perfect for theme
        ...
        <div class="card bg-base-200 shadow-xl hover:shadow-2xl transition-shadow">
          <div class="card-body">
            ...
            <p class="text-base-content/70 mb-4">
              A floating action button component for primary actions. Supports various positions and
              sub-actions.
            </p>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body text-center">
              ...
              <p>
                All action components are built with WCAG 2.1 AA compliance in mind, ensuring they
                work for all users.
              </p>
            </div>
          </div>
          ...
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body text-center">
              ...
              <p>
                Components automatically adapt to your DaisyUI theme, providing consistent styling
          ...
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body text-center">
              ...
              <p>
                Built with modern Vue 3 patterns and optimized for performance, ensuring smooth
                interactions.
              </p>
            </div>
          </div>
          ...
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body">
              ...
              <div class="space-y-3 mb-4">
                ...
                <BpButton style="ghost" size="sm"> Cancel </BpButton>
              ...
              <div class="mockup-code text-left">
                ...
                <pre
                  data-prefix="<"
                ><code>&lt;BpButton color="ghost"&gt;Cancel&lt;/BpButton&gt;</code></pre>
              </div>
            </div>
          </div>
          ...
          <div class="card bg-base-200 shadow-xl">
            <div class="card-body">
              ...
              <div class="space-y-3 mb-4">
                ...
                <BpButton style="ghost" size="sm"> Back </BpButton>
                <BpButton style="link" size="sm"> Skip </BpButton>
              </div>

              <div class="mockup-code text-left">
                <pre
                  data-prefix="<"
                ><code>&lt;BpButton color="accent"&gt;Next&lt;/BpButton&gt;</code></pre>
                <pre
                  data-prefix="<"
                ><code>&lt;BpButton color="ghost"&gt;Back&lt;/BpButton&gt;</code></pre>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="mb-16">
        <div class="card bg-primary text-primary-content shadow-xl">
          <div class="card-body text-center">
            ...
            <p class="mb-6">
              Start building interactive interfaces with our action components. Each component is
...
definePageMeta({
  ...
  description:
    'Interactive action components for user interactions - buttons, dropdowns, modals, and more',
})
