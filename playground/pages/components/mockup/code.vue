<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Code Mockup</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Show code blocks in a code editor-like box.</p>
            </div>
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body">
                        <div class="mockup-code">
                            <pre data-prefix="$"><code>npm i @nuxt-design-system/core</code></pre>
...
definePageMeta({ title: 'Code Mockup', description: 'Code mockup examples' })
