<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Window Mockup</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Show content in a desktop window mockup.</p>
            </div>
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body">
                        <div class="mockup-window border bg-base-300">
                            <div class="border-t bg-base-100 p-6">Hello world!</div>
                        </div>
                    </div>
                </div>
            </section>
