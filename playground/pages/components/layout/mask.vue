<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Mask</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Crop content to common shapes.</p>
            </div>
            ...
            <section class="mb-16">
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body flex gap-6 flex-wrap">
                        <img class="mask mask-squircle w-24" src="https://picsum.photos/96?1" />
                        <img class="mask mask-circle w-24" src="https://picsum.photos/96?2" />
                        <img class="mask mask-hexagon w-24" src="https://picsum.photos/96?3" />
                        <img class="mask mask-triangle w-24" src="https://picsum.photos/96?4" />
                    </div>
                </div>
            </section>
