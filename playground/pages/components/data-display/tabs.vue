            ...
            <section class="mb-16">
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body space-y-6">
                        <BpTabs v-model="active" :tabs="tabsBasic" />
                        <BpTabs :tabs="tabsBasic" variant="bordered" />
                        <BpTabs :tabs="tabsBasic" variant="lifted" />
                        <BpTabs :tabs="tabsBasic" variant="boxed" size="lg" />
                    </div>
                </div>
            </section>
...
definePageMeta({
    ...
    description: 'Examples and usage for tabs',
})
