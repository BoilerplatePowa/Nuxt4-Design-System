<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">BpStatus</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Small status indicator dot.</p>
            </div>
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body">
                        <div class="flex items-center gap-4 flex-wrap">
                            <BpStatus variant="neutral" />
                            <BpStatus variant="primary" />
                            <BpStatus variant="secondary" />
                            <BpStatus variant="accent" />
                            <BpStatus variant="success" />
                            <BpStatus variant="warning" />
                            <BpStatus variant="info" />
                            <BpStatus variant="error" />
                        </div>
                    </div>
                </div>
            </section>
...
definePageMeta({ title: 'Status Component', description: 'Examples and usage for status' })
