<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">BpTextDiff</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Display differences between two texts.</p>
            </div>
            ...
            <section class="mb-16">
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body">
                        <BpTextDiff :old-text="oldText" :new-text="newText" />
                    </div>
                </div>
            </section>
...
definePageMeta({ title: 'Text Diff Component', description: 'Examples and usage for text diff' })
