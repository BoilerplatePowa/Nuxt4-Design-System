<template>
    <div class="min-h-screen bg-base-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-12">
                <h1 class="text-5xl font-bold mb-4">Dock</h1>
                <p class="text-xl text-base-content/70 max-w-3xl">Bottom navigation dock.</p>
            </div>
                ...
                <div class="card bg-base-200 shadow-xl">
                    <div class="card-body">
                        <div class="dock dock-sm">
                            <button class="btn btn-circle dock-active">🏠</button>
