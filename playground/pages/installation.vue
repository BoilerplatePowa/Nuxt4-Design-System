        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-base-content/70 max-w-3xl mx-auto">
                    Get started with Nuxt Design System in your project. Follow these steps to
                    integrate our component library seamlessly.
                </p>
            </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base-content/70 mb-4">
                                    Install the Nuxt Design System package using your preferred
                                    package manager.
                                </p>
                                ...
                                <div class="mockup-code text-left mb-4">
                                    <pre
                                        data-prefix="$"
                                    ><code>yarn add @boilerplatepowa/nuxt4-design-system</code></pre>
                                </div>

                                <div class="mockup-code text-left">
                                    <pre
                                        data-prefix="$"
                                    ><code>pnpm add @boilerplatepowa/nuxt4-design-system</code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mockup-code text-left">
                                    ...
                                    <pre
                                        data-prefix="    "
                                    ><code>    '@boilerplatepowa/nuxt4-design-system'</code></pre>
                                    <pre data-prefix="  "><code>  ],</code></pre>
                                    <pre
                                        data-prefix="  "
                                    ><code>  // Optional: Configure the module</code></pre>
                                    <pre data-prefix="  "><code>  nuxtDesignSystem: {</code></pre>
                                    <pre
                                        data-prefix="    "
                                    ><code>    // Your configuration options</code></pre>
                                    <pre data-prefix="  "><code>  }</code></pre>
                                    <pre data-prefix="})"><code>})</code></pre>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base-content/70 mb-4">
                                    Import the boilerplate CSS that includes TailwindCSS, DaisyUI,
                                    and custom themes.
                                </p>
                                ...
                                <div class="alert alert-info mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">
                                            The boilerplate CSS includes pre-configured themes and
                                            optimizations.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mockup-code text-left">
                                    <pre
                                        data-prefix="/*"
                                    ><code>/* assets/css/main.css */</code></pre>
                                    <pre
                                        data-prefix="@"
                                    ><code>@import '@boilerplatepowa/nuxt4-design-system/runtime/assets/main.css';</code></pre>
                                    <pre data-prefix=""><code></code></pre>
                                    <pre
                                        data-prefix="/*"
                                    ><code>/* Your custom styles */</code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-base-content/70 mb-4">
                                    Components are auto-imported and ready to use in your Vue
                                    templates.
                                </p>
                ...
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                The boilerplate CSS includes custom themes and all DaisyUI themes.
                            </p>
                            ...
                            <div class="alert alert-success mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">
                                        boilerplate-light, boilerplate-dark, and all standard
                                        DaisyUI themes
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="mockup-code text-left">
                                ...
                                <pre
                                    data-prefix="/*"
                                ><code>/* - boilerplate-light (default) */</code></pre>
                    ...
                    <div class="card bg-base-200 shadow-xl">
                        <div class="card-body">
                            ...
                            <p class="mb-4">
                                Override default component configurations and add custom variants.
                            </p>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-sm text-base-content/70 mb-2">
                                        Make sure the module is properly added to your
                                        <code class="bg-base-300 px-1 rounded">nuxt.config.ts</code>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-base-content/70 mb-2">
                                        Ensure TailwindCSS and DaisyUI are properly configured. The
                                        module should handle this automatically.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-base-content/70 mb-2">
                                        Check that your
                                        <code class="bg-base-300 px-1 rounded">tsconfig.json</code>
                                        includes the module types.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section class="mb-16">
                <div class="card bg-primary text-primary-content shadow-xl">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-6">
                            Now that you have the module installed, explore our components and start
