    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-base-content/70 max-w-3xl mx-auto">
          Get started with Nuxt Design System in your project. Follow these steps to integrate our
          component library seamlessly.
        </p>
      </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-base-content/70 mb-4">
                  ...
                  <code class="bg-base-300 px-2 py-1 rounded">nuxt.config.ts</code>
                  file.
                </p>
            ...
            <div class="card-body">
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <p class="text-sm text-base-content/70 mb-2">
                    Ensure TailwindCSS and DaisyUI are properly configured. The module should handle
                    this automatically.
                  </p>
                </div>
      ...
      <section class="mb-16">
        <div class="card bg-primary text-primary-content shadow-xl">
          <div class="card-body text-center">
            ...
            <p class="mb-6">
              Now that you have the module installed, explore our components and start building
              amazing interfaces!
            </p>
