    ...
    <header class="navbar bg-base-200 shadow-lg sticky top-0 z-50">
      ...
      <div class="navbar-center hidden lg:flex">
        <ul class="menu menu-horizontal px-1">
          ...
          <li><NuxtLink to="/installation" class="hover:text-primary">Installation</NuxtLink></li>
          <li><NuxtLink to="/components" class="hover:text-primary">Components</NuxtLink></li>
          <li><NuxtLink to="/examples" class="hover:text-primary">Examples</NuxtLink></li>
        </ul>
      </div>
      ...
      <div class="navbar-end">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <li><button @click="setTheme('corporate')" class="flex items-center gap-2">
              <BpIcon name="building" class="w-4 h-4" />
              Corporate
            </button></li>
            <li><button @click="setTheme('synthwave')" class="flex items-center gap-2">
        ...
        <!-- GitHub Link -->
        <a href="https://github.com/BoilerplatePowa/Nuxt4-Design-System" target="_blank" class="btn btn-ghost btn-circle">
    ...
    <footer class="footer footer-center p-10 bg-base-300 text-base-content">
      ...
      <div>
        <div class="grid grid-flow-col gap-4">
          <a href="https://github.com/BoilerplatePowa/Nuxt4-Design-System" target="_blank" class="link link-hover">
            <BpIcon name="external-link" class="w-5 h-5" />
          </a>
          ...
          <a href="https://github.com/BoilerplatePowa/Nuxt4-Design-System/issues" target="_blank" class="link link-hover">Support</a>
        </div>
      </div>
    </footer>
  </div>
